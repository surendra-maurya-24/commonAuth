...
public class WebSecurityConfig {
    ...
    /**
     * Base security filter chain.
     * Each microservice should override requestMatchers to expose its own public endpoints.
     */
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.
            ...
            .authorizeHttpRequests(auth -> auth
                // Default: everything requires authentication
